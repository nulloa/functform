#' asg_mix2
#' 
#' Runs Asymmetric Gaussian MCMC with a mixed group mean structure accross the season
#'
...
asg_mix2 <- function(y, x, count, group, season, priors, niter=4000, nwarmup=niter/2, nchains=3, thin=1, inits=NULL){
  # Load Library
  require(rstan)
  ...
  m <- stan(file = system.file("model", "asgMix2.stan", package = "functform"), 
