#' asg_simple_sc
#' 
#' Runs Asymmetric Gaussian MCMC with a season mean structure accross the groups
#'
...
asg_simple_sc <- function(y, x, count, group, season, priors, niter=4000, nwarmup=niter/2, nchains=3, thin=1, inits=NULL){
  # Load Library
  require(rstan)
  ...
  m <- stan(file = system.file("model", "asgSimpleSC.stan", package = "functform"), 
