#' asg_indep
#' 
#' Runs Asymmetric Gaussian MCMC with a independent mean structure
#'
...
asg_indep <- function(y, x, count, group, season, priors, niter=4000, nwarmup=niter/2, nchains=3, thin=1, inits=NULL){
  # Load Library
  require(rstan)
  ...
  m <- stan(file = system.file("model", "asgIndep.stan", package = "functform"), 
