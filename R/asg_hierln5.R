#' asg_hierln5
#' 
#' Runs Asymmetric Gaussian MCMC with a hierarchical mean structure accross the groups using log-normal hierarchical models with only one intercept
#'
...
asg_hierln5 <- function(y, x, count, group, priors, niter=2000, nchains=3, nclusters=nchains, burnin=niter/2, thin=10, inits=NULL, mle=FALSE){
  # Load Library
  require(R2jags)
