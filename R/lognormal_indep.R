...
lognormal_indep <- function(y, x, count, group, priors, niter, nchains=3, burnin=niter/10, thin=10){
  # Load Library
  require(rjags)
  ...
  m = jags.model(textConnection(Indep), data=dat, n.chains=nchains, n.adapt=burnin)
